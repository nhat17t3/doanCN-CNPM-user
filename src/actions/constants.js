...
export const suggestionConstants = {
  ...
  CANCEL_ADD_SUGGESTION_REQUEST: "CANCEL_ADD_SUGGESTION_REQUEST",
  CANCEL_ADD_SUGGESTION_SUCCESS: "CANCEL_ADD_SUGGESTION_SUCCESS",
  CANCEL_ADD_SUGGESTION_FAILURE: "CANCEL_ADD_SUGGESTION_FAILURE",
...
export const notifyConstants = {
  GET_NOTIFY_BY_TUTOR_REQUEST: "GET_NOTIFY_BY_TUTOR_REQUEST",
  GET_NOTIFY_BY_TUTOR_SUCCESS: "GET_NOTIFY_BY_TUTOR_SUCCESS",
  GET_NOTIFY_BY_TUTOR_FAILURE: "GET_NOTIFY_BY_TUTOR_FAILURE",

  GET_NOTIFY_BY_STUDENT_REQUEST: "GET_NOTIFY_BY_STUDENT_REQUEST",
  GET_NOTIFY_BY_STUDENT_SUCCESS: "GET_NOTIFY_BY_STUDENT_SUCCESS",
  GET_NOTIFY_BY_STUDENT_FAILURE: "GET_NOTIFY_BY_STUDENT_FAILURE",
};


export const billConstants = {
  GET_BILL_BY_TUTOR_REQUEST: "GET_BILL_BY_TUTOR_REQUEST",
  GET_BILL_BY_TUTOR_SUCCESS: "GET_BILL_BY_TUTOR_SUCCESS",
  GET_BILL_BY_TUTOR_FAILURE: "GET_BILL_BY_TUTOR_FAILURE",

  PAY_BY_TUTOR_REQUEST: "PAY_BY_TUTOR_REQUEST",
  PAY_BY_TUTOR_SUCCESS: "PAY_BY_TUTOR_SUCCESS",
  PAY_BY_TUTOR_FAILURE: "PAY_BY_TUTOR_FAILURE",

};

export const classConstants = {
  GET_ALL_CLASS_BY_TUTOR_REQUEST: "GET_ALL_CLASS_BY_TUTOR_REQUEST",
  GET_ALL_CLASS_BY_TUTOR_SUCCESS: "GET_ALL_CLASS_BY_TUTOR_SUCCESS",
  GET_ALL_CLASS_BY_TUTOR_FAILURE: "GET_ALL_CLASS_BY_TUTOR_FAILURE",

  GET_ALL_CLASS_BY_STUDENT_REQUEST: "GET_ALL_CLASS_BY_STUDENT_REQUEST",
  GET_ALL_CLASS_BY_STUDENT_SUCCESS: "GET_ALL_CLASS_BY_STUDENT_SUCCESS",
  GET_ALL_CLASS_BY_STUDENT_FAILURE: "GET_ALL_CLASS_BY_STUDENT_FAILURE",

  FINISH_CLASS_BY_TUTOR_REQUEST: "FINISH_CLASS_BY_TUTOR_REQUEST",
  FINISH_CLASS_BY_TUTOR_SUCCESS: "FINISH_CLASS_BY_TUTOR_SUCCESS",
  FINISH_CLASS_BY_TUTOR_FAILURE: "FINISH_CLASS_BY_TUTOR_FAILURE",
