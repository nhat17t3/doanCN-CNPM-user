...
import { getListClassByStudent } from "../../../actions/Class/class.actions";
import Layout from "../../../components/Layout";
import ListMyClassStudent from "../ListMyClassStudent";

MyScheduleStudent.propTypes = {};

function MyScheduleStudent(props) {
  ...
  const postView = useSelector((state) => {
    const foundPost = state.classes.listClassByStudent.find((x) => x.idClass === +classId);
    return foundPost;
  });

  const v = useSelector((state) => state.classes.listClassByStudent);
...
export default MyScheduleStudent;
