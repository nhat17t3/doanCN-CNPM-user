...
import { addSuggestion } from "../../../actions/Suggestion/suggestion.actions";
...
function InforPost(props) {
  ...
  const checkSuggestion = postView?.candidates.some((x) => x.tutor.id === +userID);


  const handleApplyPostClick = () => {
    dispatch(addSuggestion(+postId));
  }
                ...
                <ul className="post-infor__list">
                  ...
                  {role == "ROLE_TUTOR" ? (
                    <li className="post-infor__item">
                      ...
                      {postView?.status == "OPEN" ? (
                        checkSuggestion == false ? (
                          <button
                            className="btn btn--primary"
                            onClick={handleApplyPostClick}
                          >
                            Đề nghị dạy
                          </button>
                        ) : (
