...
function UpdateTutor(props) {
  ...
  useEffect(() => {
    if (editedTutor.schedules != null) {
      ...
      setSang_8(editedTutor.schedules.sang_cn);
      setChieu_8(editedTutor.schedules.chieu_cn);
      setToi_8(editedTutor.schedules.toi_cn);
    }
  }, [editedTutor, a]);
  ...
  const edittutor = async (e) => {
    ...
    formData.append("data", JSON.stringify(k));
    console.log("update avatar", avatar, cmnd, k.toString());

    await dispatch(changeInformation(formData));
    setA(!a);
            ...
            <div className="addpost__content">
              <div className>
                <div className="grid__row">
                  ...
                  <div className="grid__column-6">
                    <div className="tutor-avatar">
                      <span>Ảnh chứng minh nhân dân</span>
                      <div className="tutor-container ">
                        <img
                          src={
                            cmnd !== null
                        ...
                        <label>
                          ...
                          <input
                            ...
                            file-upload
                            // onChange={imageHandler}
                            onChange={(e) => setCmnd(e.target.files[0])}
                          />
                        </label>
                      </div>
                      {/* <button
